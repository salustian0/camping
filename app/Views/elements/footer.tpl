 ...
 <strong>Copyright &copy; 2021 <a href="{{site_url()}}">{{COPYHIGHT}}</a>.</strong>
 All rights reserved.
...
<script src="{{site_url('assets/adminLTE/plugins/jquery-validation/jquery.validate.min.js')}}"></script>
<script src="{{site_url('assets/adminLTE/plugins/jquery-validation/additional-methods.min.js')}}"></script>
